      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="p-6">
          <p className="text-gray-600 leading-relaxed">
            This demo showcases Next.js 14's parallel routes feature, allowing
            multiple pages to load simultaneously in the same layout. Notice how
            the team and analytics sections load independently, creating a
