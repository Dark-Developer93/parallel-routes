  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="p-6 col-span-2 md:col-span-2 lg:col-span-2 sm:col-span-1">
          ...
          <div className="mt-6 grid  col-span-2 md:col-span-2 lg:col-span-2 sm:col-span-1 gap-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                Updates only the changed content while preserving the rest of
                the page
              </p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                Render different content based on certain conditions like
